<form action="" method="POST" class="form my-2 mx-auto" style="width:100%;max-width:400px">
    <h4>Remove Lecturer</h4>
    <?php if ($lecturerExistsError) : ?>
    ...
    <?php endif; ?>
    <input class="form-control" type="text" name="name" placeholder="Lecturer Name" value="<?= get_var('name'); ?>" autofocus>
    ...
    <form method="POST">
        ...
        <?php else : ?>
            <?php if (count($_POST) > 0) : ?>
                <h4 class="text-center">No lecturers were found at this time</h4>
            <?php endif; ?>
        <?php endif; ?>
    </form>
